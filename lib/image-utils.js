...
console.log(require("sdk/system"))

const archFolder = (require("sdk/system").architecture == "x86_64") ? "x64/" : "";
const platformExt = (require("sdk/system").platform == "winnt") ? "dll" : "so";
const data = require("sdk/self").data;
const Library = Services.io.newURI(data.url("native/" + archFolder + "ImageUtils." + platformExt),null,null)
    .QueryInterface(Ci.nsIFileURL).file.path;

exports.compress = function(src, dst) {
    var ret = 0;
    try {
        var lib = ctypes.open(Library);
