...
exports.upscaleAndSave = function(imgSrc, savePath, scaleFactor, callback) {
    var scale = scaleFactor == exports.SCALE_1_6 ? "1" : "2";
    createPostRequest(savePath, "scale=" + scale + "&noise=" + prefs.getNoiseLevel() + "&url=" + encodeURIComponent(imgSrc), null, callback);
}

exports.uploadAndUpscaleImage = function(srcPath, scaleFactor, callback) {
    var scale = scaleFactor == exports.SCALE_1_6 ? "1" : "2";
